...
public class OperationType extends BerBitString {
	...
	public OperationType(byte[] code) {
		super(code);
	}

	public OperationType(byte[] value, int numBits) {
		super(value, numBits);
	}

	public OperationType(boolean[] value) {
		super(value);
	}
