...
public class E4EResultCode extends BerInteger {

	private static final long serialVersionUID = 1L;

	public E4EResultCode() {
	}

	public E4EResultCode(byte[] code) {
		super(code);
	}

	public E4EResultCode(BigInteger value) {
		super(value);
	}

	public E4EResultCode(long value) {
		super(value);
	}
