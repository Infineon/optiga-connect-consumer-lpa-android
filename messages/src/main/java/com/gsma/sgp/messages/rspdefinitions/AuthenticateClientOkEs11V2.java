...
public class AuthenticateClientOkEs11V2 implements BerType, Serializable {
	...
	public static class EventEntries implements BerType, Serializable {
		...
		private List<EventRecord> seqOf = null;

		public EventEntries() {
			seqOf = new ArrayList<EventRecord>();
		}
		...
		public int decode(InputStream is, boolean withTag) throws IOException {
			...
			while (subCodeLength < totalLength) {
				EventRecord element = new EventRecord();
		...
		public void appendAsString(StringBuilder sb, int indentLevel) {
			...
			if (seqOf == null) {
				...
				Iterator<EventRecord> it = seqOf.iterator();
				if (it.hasNext()) {
	...
	public AuthenticateClientOkEs11V2() {
	}

	public AuthenticateClientOkEs11V2(byte[] code) {
		this.code = code;
	}
