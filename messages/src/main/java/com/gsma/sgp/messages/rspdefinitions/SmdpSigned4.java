...
public class SmdpSigned4 implements BerType, Serializable {
	...
	private BerUTF8String activationCodeForProfileRecovery = null;
	
	public SmdpSigned4() {
	}

	public SmdpSigned4(byte[] code) {
		this.code = code;
	}
	...
	public void setActivationCodeForProfileRecovery(BerUTF8String activationCodeForProfileRecovery) {
		this.activationCodeForProfileRecovery = activationCodeForProfileRecovery;
	}

	public BerUTF8String getActivationCodeForProfileRecovery() {
		return activationCodeForProfileRecovery;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (activationCodeForProfileRecovery != null) {
			codeLength += activationCodeForProfileRecovery.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 1)) {
			activationCodeForProfileRecovery = new BerUTF8String();
			subCodeLength += activationCodeForProfileRecovery.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
		}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (activationCodeForProfileRecovery != null) {
			...
			sb.append("activationCodeForProfileRecovery: ").append(activationCodeForProfileRecovery);
		}
