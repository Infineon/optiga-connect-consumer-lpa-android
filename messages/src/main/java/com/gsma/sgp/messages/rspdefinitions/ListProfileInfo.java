...
public class ListProfileInfo implements BerType, Serializable {
	...
	public static class SearchCriteria implements BerType, Serializable {
		...
		public int decode(InputStream is, BerTag berTag) throws IOException {
			...
			if (berTag.equals(BerTag.CONTEXT_CLASS, BerTag.PRIMITIVE, 0)) {
				...
				codeLength += profileOwnerOid.decode(is, false);
				return codeLength;
			}
	...
	public static final BerTag tag = new BerTag(BerTag.CONTEXT_CLASS, BerTag.CONSTRUCTED, 5);

	public byte[] code = null;
	private SearchCriteria searchCriteria = null;
	private BerOctetString tagList = null;
	
	public ListProfileInfo() {
	}

	public ListProfileInfo(byte[] code) {
		this.code = code;
	}
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (searchCriteria != null) {
			...
			sb.append("searchCriteria: <empty-required-field>");
		}
