...
public class ProfileElement implements BerType, Serializable {
	...
	private PEEAP eap = null;
	private PEDF5GS df5gs = null;
	private PEDFSAIP dfSaip = null;
	...
	public void setDf5gs(PEDF5GS df5gs) {
		this.df5gs = df5gs;
	}

	public PEDF5GS getDf5gs() {
		return df5gs;
	}

	public void setDfSaip(PEDFSAIP dfSaip) {
		this.dfSaip = dfSaip;
	}

	public PEDFSAIP getDfSaip() {
		return dfSaip;
	}
