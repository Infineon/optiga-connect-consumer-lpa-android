...
public class CtxParamsForProfileRecovery implements BerType, Serializable {
	...
	public CtxParamsForProfileRecovery() {
	}

	public CtxParamsForProfileRecovery(byte[] code) {
		this.code = code;
	}
