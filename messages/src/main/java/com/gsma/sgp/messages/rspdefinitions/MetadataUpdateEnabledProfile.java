...
public class MetadataUpdateEnabledProfile implements BerType, Serializable {
	...
	public MetadataUpdateEnabledProfile() {
	}

	public MetadataUpdateEnabledProfile(byte[] code) {
		this.code = code;
	}
