...
public class EUICCSigned3 implements BerType, Serializable {
	...
	private BerOctetString eacEuiccOtpk = null;
	...
	public void setEacEuiccOtpk(BerOctetString eacEuiccOtpk) {
		this.eacEuiccOtpk = eacEuiccOtpk;
	}

	public BerOctetString getEacEuiccOtpk() {
		return eacEuiccOtpk;
	}
	...
	public int encode(OutputStream reverseOS, boolean withTag) throws IOException {
		...
		if (eacEuiccOtpk != null) {
			codeLength += eacEuiccOtpk.encode(reverseOS, false);
	...
	public int decode(InputStream is, boolean withTag) throws IOException {
		...
		if (berTag.equals(BerTag.APPLICATION_CLASS, BerTag.PRIMITIVE, 73)) {
			eacEuiccOtpk = new BerOctetString();
			subCodeLength += eacEuiccOtpk.decode(is, false);
			if (subCodeLength == totalLength) {
				return codeLength;
			}
			subCodeLength += berTag.decode(is);
	...
	public void appendAsString(StringBuilder sb, int indentLevel) {
		...
		if (eacEuiccOtpk != null) {
			...
			sb.append("eacEuiccOtpk: ").append(eacEuiccOtpk);
		}
