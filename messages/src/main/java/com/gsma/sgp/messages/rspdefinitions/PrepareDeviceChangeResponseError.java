...
public class PrepareDeviceChangeResponseError implements BerType, Serializable {
	...
	public PrepareDeviceChangeResponseError() {
	}

	public PrepareDeviceChangeResponseError(byte[] code) {
		this.code = code;
	}
